...
# -- folder to data!
gispath = r'c:\SpaFHY_RAW_DATA\Lompolonjanka\1'
...
gis = create_catchment(pgen, gispath, plotgrids=True, plotdistr=True)


#-----------------------------------------------------------------------------------------------------#

# write gis dictionary into dat-files that spafhy can read
for key in dict.keys(gis):
    fname = 'c:\SpaFHy_v1_Pallas/data/C3/' + key + '.dat'
